...
void cryptoship::cleanup()
{
    ...
    for (auto game_itr = games_by_expiry.begin(); count > 0 && game_itr != upper; count--, game_itr++)
    {
        ...
        else
        {
            ...
            // when a game is expired at most one of the players can get a payout (no draw)
